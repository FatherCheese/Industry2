...
public class IndustryConfig {
    ...
    public IndustryConfig() {
        ...
        properties.addCategory("Block IDs")
                ...
                .addEntry("arrayLV", nextBlockID())
                .addEntry("arrayMV", nextBlockID())
                .addEntry("arrayHV", nextBlockID())
                .addEntry("arrayEHV", nextBlockID())
                .addEntry("batboxLV", nextBlockID())
                .addEntry("batboxMV", nextBlockID())
                .addEntry("batboxHV", nextBlockID())
                .addEntry("batboxEHV", nextBlockID())
                .addEntry("transformerMVtoLV", nextBlockID())
                .addEntry("transformerHVtoMV", nextBlockID())
                .addEntry("transformerEHVtoHV", nextBlockID())
                .addEntry("machineFurnace", nextBlockID())
                .addEntry("machineMacerator", nextBlockID())
                .addEntry("machineCompressor", nextBlockID())
                .addEntry("machineWiremill", nextBlockID())
                .addEntry("machineExtractor", nextBlockID())
                .addEntry("machineRecycler", nextBlockID())
                .addEntry("machineCannery", nextBlockID())
                .addEntry("advancedFurnace", nextBlockID())
                .addEntry("advancedMacerator", nextBlockID())
                .addEntry("advancedCompressor", nextBlockID())
                .addEntry("advancedCutter", nextBlockID())
                .addEntry("advancedExtractor", nextBlockID())
