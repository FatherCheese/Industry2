...
class BlockGenerator(key: String?, id: Int, material: Material?) : BlockTileEntityRotatable(key, id, material) {
    ...
    private val machineTexture: Array<IntArray> = arrayOf(
        TextureHelper.getOrCreateBlockTexture(Industry2.MOD_ID, "machine_generator.png"),
        TextureHelper.getOrCreateBlockTexture(Industry2.MOD_ID, "machine_generator_on.png"),
    ...
    companion object {
        private var instance: BlockGenerator? = null

        private fun setupInstance(machine: BlockGenerator) {
            instance = machine
        }

        private fun getInstance(): BlockGenerator {
