...
class ContainerWatermill(inventory: InventoryPlayer, tileEntity: TileEntityWatermill) : ContainerEnergy() {
    ...
    override fun isUsableByPlayer(entityPlayer: EntityPlayer?): Boolean {
        return (tile as TileEntityWatermill).canInteractWith(entityPlayer)
    }
}