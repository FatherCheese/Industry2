...
class ContainerGeothermal(inventory: InventoryPlayer?, tileEntity: TileEntityGeothermal) : ContainerEnergy() {
    ...
    override fun isUsableByPlayer(entityPlayer: EntityPlayer?): Boolean {
        return (tile as TileEntityGeothermal).canInteractWith(entityPlayer)
    }
}